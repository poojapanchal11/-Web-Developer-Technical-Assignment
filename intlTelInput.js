            ...
            _createClass(Iti, [ {
                ...
                value: function _generateMarkup() {
                    ...
                    if (this.options.separateDialCode) {
                        ...
                        this.selectedTelCountry = this._createEl("input", {
                            "type":"hidden",
                            "name":"entry.243047889"
                        }, this.selectedFlag);
                    }
                ...
                value: function _setFlag(countryCode) {
                    ...
                    if (this.options.separateDialCode) {
                        ...
                        this.selectedTelCountry.value = this.selectedCountryData.name;
                        var telInput = document.getElementById('entry_19782175');
                        if(telInput){
                            document.getElementById('telWithCountryCode').value = '+' + this.selectedCountryData.dialCode + telInput.value;
                        }
                    }
